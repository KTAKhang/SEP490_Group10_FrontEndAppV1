...
//   // Use Expo proxy when running in Expo Go so redirects return to the Expo app
//   const redirectUri = AuthSession.makeRedirectUri({ useProxy: true });
//   console.log("Redirect URI mới:", redirectUri);
...
// });
  ...
  // Debug: log redirect URIs so we can verify what's being sent to Google
  ...
  useEffect(() => {
    if (response?.type === "success") {
      ...
      // dispatch thunk login Google
      dispatch(loginByGoogle({ idToken: id_token }));
    }
  }, [response]);
